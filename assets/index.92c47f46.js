...
`].filter(bn).join(`
`)),a=ar(a),a=ba(a,e),a=ya(a,e),r=ar(r),r=ba(r,e),r=ya(r,e),a=Aa(a),r=Aa(r),e.isWebGL2&&e.isRawShaderMaterial!==!0&&(A=`#version 300 es
