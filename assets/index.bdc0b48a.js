...
`)}function Qd(o,t){const e={},i=o.getProgramParameter(t,35721);for(let n=0;n<i;n++){const s=o.getActiveAttrib(t,n),a=s.name;let r=1;s.type===35674&&(r=2),s.type===35675&&(r=3),s.type===35676&&(r=4),e[a]={type:s.type,location:o.getAttribLocation(t,a),locationSize:r}}return e}function yn(o){return o!==""}function Ta(o,t){const e=t.numSpotLightShadows+t.numSpotLightMaps-t.numSpotLightShadowsWithMaps;return o.replace(/NUM_DIR_LIGHTS/g,t.numDirLights).replace(/NUM_SPOT_LIGHTS/g,t.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,t.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,e).replace(/NUM_RECT_AREA_LIGHTS/g,t.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,t.numPointLights).replace(/NUM_HEMI_LIGHTS/g,t.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,t.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,t.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,t.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,t.numPointLightShadows)}function ya(o,t){return o.replace(/NUM_CLIPPING_PLANES/g,t.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,t.numClippingPlanes-t.numClipIntersection)}const Jd=/^[ \t]*#include +<([\w\d./]+)>/gm;function ar(o){return o.replace(Jd,$d)}function $d(o,t){const e=At[t];if(e===void 0)throw new Error("Can not resolve #include <"+t+">");return ar(e)}const tf=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function Aa(o){return o.replace(tf,ef)}function ef(o,t,e,i){let n="";for(let s=parseInt(t);s<parseInt(e);s++)n+=i.replace(/\[\s*i\s*\]/g,"[ "+s+" ]").replace(/UNROLLED_LOOP_INDEX/g,s);return n}function wa(o){let t="precision "+o.precision+` float;
precision `+o.precision+" int;";return o.precision==="highp"?t+=`
#define HIGH_PRECISION`:o.precision==="mediump"?t+=`
#define MEDIUM_PRECISION`:o.precision==="lowp"&&(t+=`
#define LOW_PRECISION`),t}function nf(o){let t="SHADOWMAP_TYPE_BASIC";return o.shadowMapType===Va?t="SHADOWMAP_TYPE_PCF":o.shadowMapType===wo?t="SHADOWMAP_TYPE_PCF_SOFT":o.shadowMapType===bn&&(t="SHADOWMAP_TYPE_VSM"),t}function sf(o){let t="ENVMAP_TYPE_CUBE";if(o.envMap)switch(o.envMapMode){case cn:case hn:t="ENVMAP_TYPE_CUBE";break;case fs:t="ENVMAP_TYPE_CUBE_UV";break}return t}function rf(o){let t="ENVMAP_MODE_REFLECTION";if(o.envMap)switch(o.envMapMode){case hn:t="ENVMAP_MODE_REFRACTION";break}return t}function af(o){let t="ENVMAP_BLENDING_NONE";if(o.envMap)switch(o.combine){case Xa:t="ENVMAP_BLENDING_MULTIPLY";break;case qo:t="ENVMAP_BLENDING_MIX";break;case Yo:t="ENVMAP_BLENDING_ADD";break}return t}function of(o){const t=o.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,i=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),7*16)),texelHeight:i,maxMip:e}}function lf(o,t,e,i){const n=o.getContext(),s=e.defines;let a=e.vertexShader,r=e.fragmentShader;const l=nf(e),h=sf(e),u=rf(e),c=af(e),d=of(e),p=e.isWebGL2?"":Zd(e),g=jd(s),m=n.createProgram();let f,_,A=e.glslVersion?"#version "+e.glslVersion+`
`:"";e.isRawShaderMaterial?(f=[g].filter(yn).join(`
`),f.length>0&&(f+=`
`),_=[p,g].filter(yn).join(`
`),_.length>0&&(_+=`
